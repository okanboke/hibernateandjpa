...
public class CityController {
    ...
    @PostMapping("/add")
    public void add(@RequestBody City city) { //yapılacak işlem body'den alınacak
    ...
    public City getById(@PathVariable int id) { //id alabilmesi içi @PathVariable anotasyonunu ekliyoruz
